...
function getPreviousSection() {
  ...
  const prevSections = sections.filter(section => section.offsetTop < currentScroll);
...
// Log initialization
console.log('%c🎯 Evi Lestari Portfolio Loaded', 'color: #00d4ff; font-size: 14px; font-weight: bold;');
